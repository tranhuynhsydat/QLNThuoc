...
public class ChiTietPhieuNhapDAO {
    public static boolean themChiTietPhieuNhap(List<ChiTietPhieuNhap> chiTietList, String maHD) {
        ...
        try (Connection conn = DatabaseConnection.getConnection(); PreparedStatement stmt = conn.prepareStatement(sql)) {
            ...
            try (ResultSet rs = stmt.executeQuery()) {
                while (rs.next()) {
                    ...
                    chiTiet.setIdHoaDon(rs.getString("maPN"));
    ...
    public static boolean capNhatChiTietPhieuNhap(ChiTietHPhieuNhap chiTietPhieuNhap) {
