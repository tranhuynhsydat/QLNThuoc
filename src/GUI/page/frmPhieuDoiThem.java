...
public class frmPhieuDoiThem extends javax.swing.JPanel {
    ...
    // <editor-fold defaultstate="collapsed" desc="Generated
        ...
        private void initComponents() {
                ...
                txtTongTienPhieuDoi = new javax.swing.JTextField();
                ...
                jPanel2Layout.setHorizontalGroup(
                                jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                                .addComponent(lblAnh, javax.swing.GroupLayout.DEFAULT_SIZE, 250,
                                                                Short.MAX_VALUE));
                jPanel2Layout.setVerticalGroup(
                                jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                                .addComponent(lblAnh, javax.swing.GroupLayout.DEFAULT_SIZE, 284,
                                                                Short.MAX_VALUE));
                ...
                jTable1.setModel(new javax.swing.table.DefaultTableModel(
                                ...
                                new String[] {
                                                "Mã thuốc", "Tên thuốc", "Thành phần", "Giá nhập", "Giá bán", "HSD",
                                                "Danh mục", "Đơn vị tính", "Xuất xứ", "Số lượng"
                                }));
                jTable1.setSelectionMode(javax.swing.ListSelectionModel.SINGLE_SELECTION);
                jTable1.setShowHorizontalLines(true);
                jScrollPane1.setViewportView(jTable1);

                jPanel53.add(jScrollPane1, java.awt.BorderLayout.PAGE_START);
                ...
                jTable2.setModel(new javax.swing.table.DefaultTableModel(
                                ...
                                new String[] {
                                                "STT", "Mã thuốc mới", "Tên thuốc mới", "Số lượng mới", "Giá bán",
                                                "Thành tiền"
                                }));
                ...
                jLabel13.setFont(new java.awt.Font("Roboto Mono Medium", 1, 14)); // NOI18N
                jLabel13.setForeground(new java.awt.Color(255, 0, 0));
                jLabel13.setText("Tổng phiếu đổi:");
                jLabel13.setPreferredSize(new java.awt.Dimension(120, 40));
                jPanel55.add(jLabel13);

                txtTongTienPhieuDoi.setEditable(false);
                txtTongTienPhieuDoi.setPreferredSize(new java.awt.Dimension(200, 40));
                txtTongTienPhieuDoi.setFocusable(false);
                txtTongTienPhieuDoi.addActionListener(new java.awt.event.ActionListener() {
                        public void actionPerformed(java.awt.event.ActionEvent evt) {
                                txtTongTienPhieuDoiActionPerformed(evt);
                        }
                });
                txtTongTienPhieuDoi.addKeyListener(new java.awt.event.KeyAdapter() {
                        public void keyReleased(java.awt.event.KeyEvent evt) {
                        }
                });
                jPanel55.add(txtTongTienPhieuDoi);
                ...
                jLabel18.setText("Chênh lệch:");
                jLabel18.setPreferredSize(new java.awt.Dimension(120, 40));
                jPanel56.add(jLabel18);

                txtChenhLech.setEditable(false);
                txtChenhLech.setFont(new java.awt.Font("Roboto Mono Medium", 0, 14)); // NOI18N
                txtChenhLech.setFocusable(false);
                txtChenhLech.setPreferredSize(new java.awt.Dimension(200, 40));
                jPanel56.add(txtChenhLech);
