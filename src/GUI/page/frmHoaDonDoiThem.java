...
public class frmHoaDonDoiThem extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        jPanel35.setPreferredSize(new java.awt.Dimension(400, 332));
        jPanel35.setLayout(new java.awt.FlowLayout(java.awt.FlowLayout.CENTER, 5, 8));

        jPanel36.setBackground(new java.awt.Color(255, 255, 255));
        jPanel36.setMinimumSize(new java.awt.Dimension(510, 187));
        jPanel36.setPreferredSize(new java.awt.Dimension(500, 230));
        jPanel36.setLayout(new java.awt.FlowLayout(java.awt.FlowLayout.LEFT));

        jPanel7.setBackground(new java.awt.Color(255, 255, 255));
        jPanel7.setLayout(new java.awt.FlowLayout(java.awt.FlowLayout.LEFT, 15, 0));
        ...
        txtMaHoaDon.setFont(new java.awt.Font("Roboto Mono", 1, 12)); // NOI18N
        txtMaHoaDon.setText("Z2NX8CN1A");
        txtMaHoaDon.setFocusable(false);
        txtMaHoaDon.setPreferredSize(new java.awt.Dimension(100, 30));
        jPanel7.add(txtMaHoaDon);

        jLabel21.setFont(new java.awt.Font("Roboto", 0, 12)); // NOI18N
        jLabel21.setText("Mã hóa đơn: ");
        jLabel21.setPreferredSize(new java.awt.Dimension(80, 30));
        jPanel7.add(jLabel21);

        txtMaHoaDon1.setEditable(false);
        txtMaHoaDon1.setFont(new java.awt.Font("Roboto Mono", 1, 12)); // NOI18N
        txtMaHoaDon1.setText("Z2NX8CN1A");
        txtMaHoaDon1.setFocusable(false);
        txtMaHoaDon1.setPreferredSize(new java.awt.Dimension(100, 30));
        jPanel7.add(txtMaHoaDon1);
        ...
        txtHoTenKH.setPreferredSize(new java.awt.Dimension(150, 30));
        ...
        cboxGioiTinhKH.setPreferredSize(new java.awt.Dimension(90, 30));
        jPanel36.add(cboxGioiTinhKH);

        jPanel37.setBackground(new java.awt.Color(255, 255, 255));
        jPanel37.setLayout(new java.awt.FlowLayout(java.awt.FlowLayout.LEFT, 15, 0));
        ...
        txtSdtKH.setPreferredSize(new java.awt.Dimension(150, 30));
        ...
        jPanel8.setPreferredSize(new java.awt.Dimension(764, 50));
        jPanel8.setLayout(new java.awt.FlowLayout(java.awt.FlowLayout.LEFT, 25, 0));
        ...
        txtThoiGian.setPreferredSize(new java.awt.Dimension(150, 30));
        ...
        jLabel22.setPreferredSize(new java.awt.Dimension(40, 30));
        jPanel10.add(jLabel22);

        txtLydo.setPreferredSize(new java.awt.Dimension(150, 30));
        jPanel10.add(txtLydo);
        ...
        txtSdtKH1.setPreferredSize(new java.awt.Dimension(150, 30));
        ...
        txtTong.setPreferredSize(new java.awt.Dimension(150, 30));
        jPanel40.add(txtTong);

        jPanel39.add(jPanel40);

        jPanel55.setBackground(new java.awt.Color(255, 255, 255));
        jPanel55.setLayout(new java.awt.FlowLayout(java.awt.FlowLayout.LEFT, 15, 0));
        ...
        txtTienKhachDua.setPreferredSize(new java.awt.Dimension(150, 30));
        jPanel55.add(txtTienKhachDua);

        jPanel39.add(jPanel55);

        jPanel56.setBackground(new java.awt.Color(255, 255, 255));
        jPanel56.setLayout(new java.awt.FlowLayout(java.awt.FlowLayout.LEFT, 25, 0));

        jLabel18.setFont(new java.awt.Font("Roboto", 0, 12)); // NOI18N
        jLabel18.setText("Tiền thừa:");
        jLabel18.setPreferredSize(new java.awt.Dimension(80, 30));
        ...
        txtTienThua.setPreferredSize(new java.awt.Dimension(150, 30));
