    ...
    private void loadDataToTable() {
        SwingWorker<Void, Void> worker = new SwingWorker<Void, Void>() {
            ...
            protected Void doInBackground() throws Exception {
                startIndex = 0;
                // Fetch data from PhieuTraDAO (Return Invoice Data)
                List<PhieuTra> danhSachHoaDonTra = PhieuTraDAO.getHoaDonTraBatch(startIndex, 10);
                ...
                if (danhSachHoaDonTra == null || danhSachHoaDonTra.isEmpty()) {
                    ...
                    SwingUtilities.invokeLater(() -> {
                        ...
                        for (PhieuTra hd : danhSachHoaDonTra) {
                            Object[] rowData = {
                                    stt++, // Serial number
                                    hd.getMaPT(),
                                    hd.getTenKhachHang(),
...
//                if (PhieuTraDAO.xoaHoaDonTra(maPD)) {
