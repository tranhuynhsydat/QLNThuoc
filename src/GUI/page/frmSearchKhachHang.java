...
public class frmSearchKhachHang extends javax.swing.JPanel {
    ...
    private void loadDataToTable() {
         ...
         SwingWorker<Void, Void> worker = new SwingWorker<Void, Void>() {
             ...
             protected Void doInBackground() throws Exception {
                 ...
                 List<KhachHang> khList = KhachHangDAO.getKhachHangBatch(startIndex, 13);  // startIndex là chỉ mục bắt đầu
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Mã KH", "Tên KH", "SĐT ", "Giới tính", "Tuổi"
            }
        ));
        jTable1.setSelectionMode(javax.swing.ListSelectionModel.SINGLE_SELECTION);
    ...
    private void btnChiTietActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnChiTietActionPerformed
        ...
        if (selectedRow != -1) {
            ...
            formThongTinKH dialog = new formThongTinKH(parentFrame, true, maKH);  // Truyền mã thuốc vào constructor
