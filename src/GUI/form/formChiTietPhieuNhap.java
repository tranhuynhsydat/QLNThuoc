 ...
 * @author Admin
 */
public class formChiTietPhieuNhap extends javax.swing.JDialog {
    private List<ChiTietPhieuNhap> listCTPN;
    private DefaultTableModel modal;
    /**
     * Creates new form formChiTietPhieuNhap
     */
    public formChiTietPhieuNhap(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    public formChiTietPhieuNhap(java.awt.Frame parent, boolean modal, List<ChiTietPhieuNhap> ctpn) {
        super(parent, modal);
        this.listCTPN = ctpn;
        initComponents();
        fillInput();
    ...
    if (!listCTPN.isEmpty()) {
        String maPhieuNhap = listCTPN.get(0).getIdPhieuNhap();
        txtMaHD.setText(maPhieuNhap);

        PhieuNhap phieuNhap = PhieuNhapDAO.getPhieuNhapByMaPN(maPhieuNhap);
        if (phieuNhap != null) {
            txtTenKH.setText(phieuNhap.getNhaCungCap().getTenNhaCungCap());
            txtTenNV.setText(phieuNhap.getNhanVien().getHoTen());
        } else {
            txtTenKH.setText("Không tìm thấy NCC");
    ...
    private void btnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPrintActionPerformed
        String maPN = listCTPN.get(0).getIdPhieuNhap(); 
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(formChiTietPhieuNhap.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                formChiTietPhieuNhap dialog = new formChiTietPhieuNhap(new javax.swing.JFrame(), true);
